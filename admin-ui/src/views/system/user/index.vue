<template>
  <div class="app-container">
    ...
    <!-- 添加或修改用户配置对话框 -->
    <el-dialog :title="title" :visible.sync="open" :close-on-click-modal="false" width="600px" append-to-body class="scrollbar">
    ...
    <!-- 用户导入对话框 -->
    <el-dialog :title="upload.title" :visible.sync="upload.open" :close-on-click-modal="false" width="400px" append-to-body class="scrollbar">
      <el-upload
        ref="upload"
        :limit="1"
        accept=".xlsx, .xls"
