...
import com.dragon.framework.shiro.service.SysPasswordService;
...
public class SysIndexController extends BaseController
{
    ...
    public String index(ModelMap mmap)
    {
        ...
        mmap.put("copyrightYear", BlogConfig.getCopyrightYear());
        mmap.put("demoEnabled", BlogConfig.isDemoEnabled());
    ...
    {
        mmap.put("version", BlogConfig.getVersion());
        return "main";
    }
